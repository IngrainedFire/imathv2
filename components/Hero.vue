...
<template>
  <section class="relative overflow-hidden m-[50px] min-h-[85dvh] border-yellow border-4 rounded-3xl ">
    <div id="hero-bg" >
        ...
        <div id="hero-buttons" class="w-full p-[50px] flex justify-center gap-[20px]">
          <AuthSignedOut>
            ...
            <NuxtLink
              ...
              class="flex gap-[10px] justify-center items-center py-[15px] px-[20px] bg-[#FF5787] text-white rounded-[10px]"
            >
