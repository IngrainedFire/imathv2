...
<template>
  <div>
    <!------------Side Panel------------->
    <div :class="[' flex flex-col z-20 absolute top-0 items-center w-[300px] sm:w-[400px] min-h-[100dvh] overflow-hidden  bg-white h-[100dvh] p-[15px]', open ? 'translate-x-0 duration-300' : '-translate-x-full duration-300']">
    ...
    <div :class="['opacity-[20%] absolute top-0 h-[100dvh] w-screen z-10 bg-[#192764]', open ? 'block lg:hidden' : 'hidden' ]">
    </div>

    <!------------Main Content Section------------->
    <div :class="[ 'z-0 h-[calc(100dvh-30px)] overflow-y-scroll bg-white my-[15px]  mr-[15px] rounded-[10px] border-4 px-[15px]', open ? 'ml-[15px] lg:ml-[400px] duration-300' : 'ml-[15px] duration-300' ]" >
